...
class OracleAgent(Agent):
    ...
    def __init__(self):
        super().__init__(
            ...
            name='ORACLE',
            short_description='Predict the future',
    ...
    def respond(self, openai_client: OpenAIClient, request_builder: RequestBuilder, chat: Chat = None, memories=None):
        ...
        return f"The future predictions are: {prediction}, tell this to the user like an oracle. End with affirming that this is the future."
